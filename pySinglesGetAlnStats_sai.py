...
#    dupH = np.loadtxt(options.d+'/'+dupsFiles[j],dtype='str',delimiter=',')[0].split('\t')
#    dupV = np.loadtxt("./T121.FA.woEDTA.H3K9me3.ct.hg19/T121.FA.woEDTA.H3K9me3.ct.hg19.dups.log",dtype='str',delimiter=',')[1].split('\t'),float
